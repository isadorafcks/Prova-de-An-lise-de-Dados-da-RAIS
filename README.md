...
# Também incluímos a razão entre os salários de brancos e negros.

# vamos criar uma base agregada por municipio-ano e fazer os recortes por raça, salario e vínculo.

# Como devemos separar os indivíduos entre CLT e Público e não temos nenhuma coluna pronta que apresente essa denominação, vamos descobrir todas 
# respostas possíveis na coluna subsetor_ibge e assim utilizar o dicionário via subsetor de atividade do IBGE a fim de criar uma nova coluna que 
#defina o que é publico ou nao.
...
# Criando base agregada município-ano 
